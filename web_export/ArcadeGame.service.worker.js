...
/** @type {string} */
const CACHE_VERSION = '1728853134|24241364297';
/** @type {string} */
const CACHE_PREFIX = 'ArcadeGame-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ArcadeGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ArcadeGame.html","ArcadeGame.js","ArcadeGame.offline.html","ArcadeGame.icon.png","ArcadeGame.apple-touch-icon.png","ArcadeGame.worker.js","ArcadeGame.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["ArcadeGame.wasm","ArcadeGame.pck"];
